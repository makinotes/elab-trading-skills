...
## 0 投资决策公理（漏斗的地基 · 先和用户对齐这几条，消解才有共同基准）
消解一个问题之前，先明白**为什么投资决策问题常常在被问出来之前就已经错了**：

1. **大多数"该不该"假设了预测能力**：问"财报会不会跌""该不该现在进"，暗含"我能预测方向/时点"——而这个能力大概率不存在。问题真正该问的是"不管涨跌，我的仓位/计划扛不扛得住"。
2. **成本是沉没的，历史价格不是决策变量**：套牢、浮盈、成本线都不改变"现在这个价我愿不愿意持有/新建"这个唯一有效的问题。
3. **结果 ≠ 决策质量**：一次赚了可能是运气、一次亏了可能决策没错。评估要看"再来一次这个选择还合不合理"，不是看这次输赢。

> 用户的问题一旦踩中这几条公理的反面（在预测、在纠结成本、在用结果反推决策），漏斗就有了拆解的抓手。
